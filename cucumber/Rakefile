...
Cucumber::Rake::Task.new(:corgi) do |t|
  t.cucumber_opts = 'features -p poltergeist --format pretty --profile html -t ~@api -t @corgi'
end

Cucumber::Rake::Task.new(:client) do |t|
  t.cucumber_opts = 'features -p poltergeist --format pretty --profile html -t ~@api -t @client'
end

Cucumber::Rake::Task.new(:search) do |t|
  t.cucumber_opts = 'features -p poltergeist --format pretty --profile html -t ~@api -t @search'
end
